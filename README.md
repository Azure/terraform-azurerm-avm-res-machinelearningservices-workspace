...
Description: Deletion of an AML workspace or AI Foundry hub is a "soft delete". If there is an attempt to create a new workspace or hub with the same name, it will fail until the soft-deleted workspace is purged.
