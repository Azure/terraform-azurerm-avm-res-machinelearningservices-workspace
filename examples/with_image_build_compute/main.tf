...
locals {
  tags = {
    scenario = "with_image_build_compute"
  }
}
...
# This is the module call with image_build_compute_name
module "azureml" {
  source = "../../"
  ...
  # Override the image build compute to use a specific compute cluster
