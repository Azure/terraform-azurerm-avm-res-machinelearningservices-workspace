locals {
  ...
  log_analytics_workspace_id = (var.kind == "Default" || var.log_analytics_workspace.create_new) && (var.log_analytics_workspace.resource_id == null) ? module.avm_res_log_analytics_workspace[0].resource_id : var.log_analytics_workspace.resource_id
